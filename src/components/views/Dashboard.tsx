...
const WelcomeMessage: React.FC = () => {
    return (
        <div className="welcome component">
          ...
          <p>Your progress:</p>
          <div className="mb-8"> {/* This adds a bottom margin. '8' can be adjusted to the desired space */}
            <Progress value={35} />
          </div>
          ...
          <div className="current-trips component">
            ...
            <div className="trip-container">
              <div className="trip-info">
                ...
                <Button width="80px" height="35px" backgroundColor="#FFB703">Info</Button>
              </div>
              <div className="trip-info">
          ...
          <div className="create-button-container">
              <Button width="150px" backgroundColor="#FB8500">CREATE TRIP</Button>
          </div>
        </div>
    );
